...
public class Escaner_alumno extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    private void initComponents() {
        ...
        confirmar_codigo.setBackground(new java.awt.Color(255, 255, 255));
        confirmar_codigo.setForeground(new java.awt.Color(51, 51, 51));
        ...
        jPanel1.add(confirmar_codigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 380, -1, -1));
        ...
        if (result_field.getText().equals("")) {
            ...
            try {
                ...
                if(pRes==1){
                    ...
                    // JOptionPane.showMessageDialog(null, "Compra realizada");
                    JOptionPane.showMessageDialog(null, "Visita finalziada con exito", "Salida", JOptionPane.INFORMATION_MESSAGE);
                    //limpiar_articulos();
                    //this.dispose();
                    //Se debe mostrar el total que lleva la venta
                } if(pRes==5){ 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Escaner_alumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(() -> {
            new Escaner_alumno().setVisible(true);
        });
    }
