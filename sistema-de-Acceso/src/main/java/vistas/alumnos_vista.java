...
public class alumnos_vista extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tabla_alumnos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MATRICULA", "NOMBRE", "APELLIDOS", "", "SEMESTRE", "GRUPO", "CORREO", "TELEFONO", "NOMBRE CARRERA", "TIPO DE ALUMNO"
            }
        ) {
    ...
    private void btn_mostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_mostrarActionPerformed
            ...
            modelado.addColumn("NOMBRE CARRERA");
            modelado.addColumn("TIPO DE ALUMNO");
